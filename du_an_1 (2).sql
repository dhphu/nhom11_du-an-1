...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th10 23, 2023 lúc 10:28 AM
...
CREATE TABLE `categories` (
  `id` int NOT NULL,
  `name_cate` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `comment` (
  ...
  `content` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
--
ALTER TABLE `comment`
  ADD CONSTRAINT `id_user` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `lk_order_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
